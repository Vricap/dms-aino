...
const HomePageDiv = ({
  ...
  <div className="documents-div">
    <div className="container documents">
      {paginate.query ? (
        <h3 className="recent-documents">
          Search result for: <span className="teal-text">{paginate.query}</span>
        </h3>
      ) : (
    ...
    <DeleteModal toBeDeleted={toBeDeleted} deleteItem={deleteDocument} />
  </div>
);
