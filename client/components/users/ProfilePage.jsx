...
import { logout } from "../../actions/accessActions.js";
    ...
    return (
      <div className="form-div">
        <div className="container">
          ...
          {access.user.id === profile.id && (
            <div className="input-field center">
              <Link to="/user/edit" className="waves-effect btn">
                Edit
              </Link>
              {access.user.id !== 1 && (
                <a href="#deleteModal" className="delete-btn btn">
                  Delete
                </a>
              )}
            </div>
